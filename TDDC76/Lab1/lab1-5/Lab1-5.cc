 ...
 * DATUM:         2014-10-06
 *
 * Detta program ska ta in en fil och göra olika funktioner. t.ex byta listornas innehåll, tömma listan
* ändra listans ordning etc.
 */
...
void build_lists(ifstream &file, List_Node* &list_1, List_Node* &list_2);
...
int main()
{
   ...
   // i list_1 och list_2, enligt vad som sagts om build_lists() ovan.
      build_lists(file, list_1, list_2);
      file.close();
